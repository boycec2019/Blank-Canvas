...
- `storage`, to save extension settings and user-created extension data;
- `tabs`, to read the active tab from the popup and open related assignment links;
- site access needed for Canvas pages, so the extension can read and modify Canvas page content in order to provide its features.
